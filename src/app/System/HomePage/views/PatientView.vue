...
const colMap = [
  ...
  { name: '姓名 (name)', key: 'name' },
  {
    name: '性别 (sex)',
    key: 'sex',
    func: (value: any) => `${value} (${getGenderString(value)})`
  },
  { name: '年龄 (age)', key: 'age' }
]

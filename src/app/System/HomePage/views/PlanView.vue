...
import { Plan, type ISystemPlanItem } from '@/api/system/actions'
import ReadonlyList from '@/components/List/ReadonlyList.vue'
import { useMessage } from '@/components/Message'
import { h, onMounted, reactive, ref } from 'vue'
import { createCustomModal } from '@/components/Modal'
import PlanEditVue from './_EditView/PlanEdit.vue'

type TItem = ISystemPlanItem
const Actions = Plan

const colMap = [
  { name: 'ID', key: 'id' },
  { name: '方案名称 (name)', key: 'name' },
  { name: '诊断ID (diagnosis_id)', key: 'diagnosis_id' },
  { name: '效果 (effection)', key: 'effection' }
]
